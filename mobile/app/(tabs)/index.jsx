...
const Homepage = () => {
  ...
  const loadData = async () => {
    try {
      ...
      if (!selectedCategory) setSelectedCategory(transformedCategories[1].name) // adding this line creating the previous eroor ??
  ...
  const loadCategoryData = async (category) => {
    try {
      ...
      console.log("Error while loading category data ", error);
      setRecipes([])
    }
  };
  ...
  if (loading) {
    return (
      <LoadingSpinner message="Hold on ! Your recipe is loading"/>)
  }
                   ...
                   <Image 
                    ...
                    <View style={homeStyles.featuredOverlay}>
                      <View style={homeStyles.featuredBadge}>
                        <Text style={homeStyles.featuredBadgeText}>Features</Text>
                      </View>
